    ...
    <div>
        ...
        <el-main>
            <el-table :data="newsState.news" style="width: 100%">
                ...
                <el-table-column property="author_name" label="管理员" width="200" />
                <el-table-column property="author_id" label="管理员ID" width="200" />
                <el-table-column property="create_time" label="创建时间" width="300" :formatter="formateTime" sortable />
            ...
            <el-dialog v-model="dialogVisible" :title="newsState.currentnew.title" width="60%" center>
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-upload action="" :before-upload="uploadcover" :limit="1">
                    ...
                    <el-row :span="6">
                        <el-image v-if="newsState.currentnew.cover != ''" style="width: 100px; height: 60px"
                            :src="newsState.currentnew.cover" fit="fit" />
                    </el-row>
                </el-row>
                <div class="editor">
                    <v-md-editor v-model="newsState.currentnew.content" height="400px"
...
const formateTime = (t) => {
    return (new Date(t.create_time * 1000)).toLocaleString()
}
